"""
Частина 1.1 — Завантаження сирих даних з CSV у MongoDB Atlas.

Запуск:
    python scripts/01_load_data.py

Скрипт ідемпотентний: перед завантаженням видаляє колекцію tracks_raw,
тому повторні запуски не дублюють документи.
"""
